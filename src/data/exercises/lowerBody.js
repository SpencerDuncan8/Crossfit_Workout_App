// src/data/exercises/lowerBody.js

export const lowerBodyExercises = [
  {
    id: "dumbbell-goblet-squats",
  ...
  },
  {
    ...
    execution: [
      "Take a controlled step forward or backward with one leg.",
    ...
    modifications: {
      easier: "Reduce range of motion or hold onto a stable surface for balance.",
      harder: "Jumping Lunges, or add a pause at the bottom."
    },
    breathingPattern: "Inhale down, exhale up"
  },
  {
    id: "dumbbell-front-squats",
  ...
  {
    id: "dumbbell-goblet-curtsy-lunges",
  ...
  {
    id: "single-leg-dumbbell-deadlifts",
  ...
  {
    id: "dumbbell-single-leg-hip-thrusts",
